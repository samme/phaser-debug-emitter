...
(function() {
  var COLOR_LENGTH, COLOR_OFF, COLOR_ON, KEYS, KEYS_LONG, Phaser, _areaRect, _lengthRect, _totalRect, emitterColor, emitterNext, isArray, stringValueForKey;
  ...
  emitterColor = function(emitter, color) {
    if (emitter.on) {
      return COLOR_ON;
    } else {
      return COLOR_OFF;
  ...
  emitterNext = function(emitter) {
    return emitter._timer - emitter.game.time.time;
  };
